...
export type UserAuthWhereInput = {
  ...
  lastLogin?: Prisma.DateTimeFilter<"UserAuth"> | Date | string
...
export type UserAuthScalarWhereWithAggregatesInput = {
  ...
  lastLogin?: Prisma.DateTimeWithAggregatesFilter<"UserAuth"> | Date | string
}
...
export type UserAuthOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "email" | "passwordHash" | "lastLogin", ExtArgs["result"]["userAuth"]>
...
export interface UserAuthFieldRefs {
  ...
  readonly lastLogin: Prisma.FieldRef<"UserAuth", 'DateTime'>
}

...
export const adminStats = [
    { title: 'Total Alumni', value: '2,845', iconName: 'Users', change: '+12% this month', positive: true },
    { title: 'Pending Content', value: '14', iconName: 'FileText', change: 'Needs review', positive: false },
    { title: 'Upcoming Events', value: '8', iconName: 'Calendar', change: 'Next 30 days', positive: true },
    { title: 'Donations YTD', value: '$12,500', iconName: 'CreditCard', change: '+5% vs last year', positive: true },
];
...
export const adminContentMock = [
    {
        id: 1,
        type: 'Event',
        title: 'Batch 2010 Reunion Pre-party',
        description: 'We are gathering early before the main homecoming. All batch 2010 members are invited...',
        author: 'Anna Cruz',
        timeAgo: '1 day ago',
        status: 'pending',
    },
    {
        ...
        description: 'My company is currently looking for Josenian grads who want to take on part-time freelance...',
...
export const adminDonationsMock = [
    { id: 1, date: 'Feb 14, 2026', donor: 'Anonymous', amount: '$500.00', status: 'Completed' },
    { id: 2, date: 'Feb 12, 2026', donor: 'Juan De Cruz', amount: '$150.00', status: 'Completed' },
    { id: 3, date: 'Feb 10, 2026', donor: 'Maria Santos', amount: '$1,000.00', status: 'Processing' },
];

export const adminUsersMock = [
    { id: 1, name: 'Mark Spencer', email: 'mark.spencer@example.com', batch: '2021', status: 'Pending' },
    { id: 2, name: 'Lisa Wong', email: 'lisa.wong@example.com', batch: '2018', status: 'Pending' },
    { id: 3, name: 'Maria Santos', email: 'maria.santos@example.com', batch: '2015', status: 'Official' },
    { id: 4, name: 'John Doe', email: 'john.doe@example.com', batch: '2010', status: 'Regular' },
    { id: 5, name: 'Pedro Penduko', email: 'pedro@example.com', batch: '2012', status: 'Suspended' },
    { id: 6, name: 'Scammer Admin', email: 'fake@example.com', batch: 'Unknown', status: 'Banned' },
];